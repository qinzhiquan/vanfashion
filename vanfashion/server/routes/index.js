...
router.get('/', (req, res, next) => {
    ...
    res.render('index', {title: 'vanfashion鞋店'});
});
...
router.get('/api/allgoods', (req, res) => {
    ...
    let sqlStr = 'SELECT *,SUM(og.goods_count) as salesCount from recommend as r LEFT JOIN order_goods as og on r.goods_id = og.goods_id';
